...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./../node_modules/elm-css-webpack-loader/index.js!./Stylesheets.elm", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./../node_modules/elm-css-webpack-loader/index.js!./Stylesheets.elm");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".UiButtonPrimary {\n    border: 2px solid #000000;\n    background-color: #FFFFFF;\n    padding: 10px 8px;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HenrikFricke$elm_board$Ui_Button$styles = {
		hover: _elm_lang$core$Native_List.fromArray(
			[
				_mdgriffith$elm_style_animation$Animation$backgroundColor(_elm_lang$core$Color$black),
				_mdgriffith$elm_style_animation$Animation$color(_elm_lang$core$Color$white)
			]),
		unhover: _elm_lang$core$Native_List.fromArray(
			[
				_mdgriffith$elm_style_animation$Animation$backgroundColor(_elm_lang$core$Color$white),
				_mdgriffith$elm_style_animation$Animation$color(_elm_lang$core$Color$black)
			])
	};
	var _HenrikFricke$elm_board$Ui_Button$update = F2(
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								style: A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_mdgriffith$elm_style_animation$Animation$to(_HenrikFricke$elm_board$Ui_Button$styles.hover)
										]),
									model.style)
							}),
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								style: A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_mdgriffith$elm_style_animation$Animation$to(_HenrikFricke$elm_board$Ui_Button$styles.unhover)
										]),
									model.style)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
	...
	var _HenrikFricke$elm_board$Ui_Button$init = {
		style: A2(
			...
			_HenrikFricke$elm_board$Ui_Button$styles.unhover)
	};
	var _HenrikFricke$elm_board$Ui_Button$Model = function (a) {
		return {style: a};
	};
	var _HenrikFricke$elm_board$Ui_Button$Styles = F2(
		function (a, b) {
			return {hover: a, unhover: b};
		});
	var _HenrikFricke$elm_board$Ui_Button$Animate = function (a) {
		return {ctor: 'Animate', _0: a};
	};
	var _HenrikFricke$elm_board$Ui_Button$subscriptions = function (model) {
		return A2(
			_mdgriffith$elm_style_animation$Animation$subscription,
			_HenrikFricke$elm_board$Ui_Button$Animate,
			_elm_lang$core$Native_List.fromArray(
				[model.style]));
	};
	var _HenrikFricke$elm_board$Ui_Button$Click = {ctor: 'Click'};
	var _HenrikFricke$elm_board$Ui_Button$Unhover = {ctor: 'Unhover'};
	var _HenrikFricke$elm_board$Ui_Button$Hover = {ctor: 'Hover'};
	var _HenrikFricke$elm_board$Ui_Button$view = F2(
		function (model, buttonText) {
			return A2(
				...
				A2(
					...
					A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										{ctor: '_Tuple2', _0: 'padding', _1: '10px 8px'},
						...
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Events$onMouseEnter(_HenrikFricke$elm_board$Ui_Button$Hover)
								]),
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onMouseLeave(_HenrikFricke$elm_board$Ui_Button$Unhover)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onClick(_HenrikFricke$elm_board$Ui_Button$Click)
									]))))),
				_elm_lang$core$Native_List.fromArray(
					[
	...
	var _HenrikFricke$elm_board$Ui_Button2$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('UiButton');
	var _HenrikFricke$elm_board$Ui_Button2$class = _HenrikFricke$elm_board$Ui_Button2$_p0.$class;
	var _HenrikFricke$elm_board$Ui_Button2$Primary = {ctor: 'Primary'};
	var _HenrikFricke$elm_board$Ui_Button2$css = function (_p1) {
		return _rtfeldman$elm_css$Css$stylesheet(
			A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'UiButton', _p1));
	}(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_HenrikFricke$elm_board$Ui_Button2$Primary,
				_elm_lang$core$Native_List.fromArray(
					[
						A3(
	...
	var _HenrikFricke$elm_board$Ui_Button2$primary = F2(
		function (attributes, nodes) {
			return A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_HenrikFricke$elm_board$Ui_Button2$class(
							_elm_lang$core$Native_List.fromArray(
								[_HenrikFricke$elm_board$Ui_Button2$Primary]))
						])),
				nodes);
	...
	var _HenrikFricke$elm_board$Board_Column$init = function (label) {
		return {
			label: label,
			tickets: _elm_lang$core$Native_List.fromArray(
				[]),
			button: _HenrikFricke$elm_board$Ui_Button$init
		};
	};
	var _HenrikFricke$elm_board$Board_Column$Model = F3(
		function (a, b, c) {
			return {label: a, tickets: b, button: c};
		});
	var _HenrikFricke$elm_board$Board_Column$Button = function (a) {
		return {ctor: 'Button', _0: a};
	};
	var _HenrikFricke$elm_board$Board_Column$subscriptions = function (model) {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_HenrikFricke$elm_board$Board_Column$Button,
			_HenrikFricke$elm_board$Ui_Button$subscriptions(model.button));
	};
	var _HenrikFricke$elm_board$Board_Column$AddTicket = function (a) {
		return {ctor: 'AddTicket', _0: a};
	};
		...
		function (msg, model) {
			...
			while (true) {
				...
				if (_p0.ctor === 'AddTicket') {
					...
					var _p1 = _p3;
					if (_p1.ctor === 'Click') {
						var _v2 = _HenrikFricke$elm_board$Board_Column$AddTicket('Test'),
							_v3 = model;
						msg = _v2;
						model = _v3;
						continue update;
					} else {
						var _p2 = A2(_HenrikFricke$elm_board$Ui_Button$update, _p3, model.button);
						var button = _p2._0;
						var cmd = _p2._1;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{button: button}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _HenrikFricke$elm_board$Board_Column$Button, cmd)
						};
					}
				}
			}
		});
	var _HenrikFricke$elm_board$Board_Column$view = function (model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('I\'am a button')
						])),
					A2(
					_elm_lang$html$Html_App$map,
					_HenrikFricke$elm_board$Board_Column$Button,
					A2(_HenrikFricke$elm_board$Ui_Button$view, model.button, 'Add new ticket'))
				]));
	};
	...
	var _HenrikFricke$elm_board$Board_App$subscriptions = function (model) {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_HenrikFricke$elm_board$Board_App$Backlog,
			_HenrikFricke$elm_board$Board_Column$subscriptions(model.backlog));
	};
	...
	var Elm = {};
	Elm['Main'] = Elm['Main'] || {};
	_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _HenrikFricke$elm_board$Main$main === 'undefined' ? null : _HenrikFricke$elm_board$Main$main);

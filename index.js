...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HenrikFricke$elm_board$Ui_Button$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('UiButton');
	var _HenrikFricke$elm_board$Ui_Button$class = _HenrikFricke$elm_board$Ui_Button$_p0.$class;
	var _HenrikFricke$elm_board$Ui_Button$Primary = {ctor: 'Primary'};
	var _HenrikFricke$elm_board$Ui_Button$css = function (_p1) {
		...
		function (attributes, nodes) {
			return A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_HenrikFricke$elm_board$Ui_Button$class(
							_elm_lang$core$Native_List.fromArray(
								[_HenrikFricke$elm_board$Ui_Button$Primary]))
						])),
				nodes);
	...
	var _HenrikFricke$elm_board$Board_Column$Model = F2(
		function (a, b) {
			return {label: a, tickets: b};
		});
